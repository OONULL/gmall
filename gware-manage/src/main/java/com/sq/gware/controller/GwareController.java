package com.sq.gware.controller;
...
import com.sq.gware.enums.TaskStatus;
import com.sq.gware.service.GwareService;
...
public class GwareController {
    ...
    @RequestMapping(value = "wmsWareInfo")
    @ResponseBody
    ...
    //根据skuid 返回 仓库
    @RequestMapping(value = "wmsWareSkuMap"  )
    @ResponseBody
    ...
    @RequestMapping(value = "saveWmsWareSku" ,method = RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value = "wmsWareSkuList" ,method = RequestMethod.GET,produces= MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    ...
    @RequestMapping(value = "wmsWareInfoList" ,method = RequestMethod.GET,produces="application/json;charset=UTF-8")
    @ResponseBody
